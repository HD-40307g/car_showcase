...
export async function fetchCars(filters: FilterProps) {
    ...
    const response = await fetch(`https://cars-by-api-ninjas.p.rapdapi.com/v1/cars?make=${manufacturer}&year=${year}&model=${model}&limit=${limit}&fuel_type=${fuel}`, { headers: headers });
